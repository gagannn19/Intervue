// The landing page's rotating hero description variants and FAQ copy.
export const HERO_VARIANTS = [
  "Cuecast runs a live mock interview with an AI interviewer that asks follow-ups, challenges weak reasoning, and gives you a real scorecard afterward — starting with DSA rounds.",
...
export const FAQS = [
  { q: "What is Cuecast?", a: "Cuecast is an AI-powered mock interview platform that lets you practice realistic interviews with an AI interviewer and receive detailed feedback afterward." },
  ...
  { q: "What types of interviews can I practice?", a: "Cuecast is starting with DSA interviews, with the architecture designed to support technical, system design, behavioral, HR, and other interview types later." },
